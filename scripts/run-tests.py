...
run_script("audit-state.py", "state_gate")
run_script("audit-theatre-dataflow.py", "theatre_dataflow_gate")
...
run_script("validate-system-provenance.py", "system_self_provenance")
run_script("validate-lightrag-compare.py", "lightrag_compare")
run_script("validate-cognee-compare.py", "cognee_compare")
run_script("validate-source-registry.py", "source_registry")
run_script("validate-evidence-ledger.py", "evidence_ledger")
run_script("validate-alignment-flywheel.py", "alignment_flywheel")
run_script("validate-integrity-gate.py", "integrity_gate")
run_script("validate-next-action.py", "next_action_scheduler")
...
run_script("validate-pushing-miner.py", "pushing_miner")
