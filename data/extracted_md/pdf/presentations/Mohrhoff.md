...
arXiv:quant-ph/0607005v2 14 Jul 2006

                                                                      ujm@auromail.net

                                       The physical motivation for the mathematical formalism of quantum mechanics
                                       is made clear and compelling by starting from an obvious fact—essentially, the
                                       stability of matter—and inquiring into its preconditions: what does it take to make
                                       this fact possible?
                                       Keywords: fuzziness; interpretation; probability; quantum mechanics; stability
                                       PACS numbers: 01.40.Gm; 03.65.-w; 03.65.Ca; 03.65.Ta
...
that quantum mechanics is simply a set of tools for assigning probabilities to measurement
                                               ...
                                               2
outcomes makes it easy to see that the concepts of classical physics, being rooted in the
...
Schrödinger equation. The final section lists the typical postulates of standard axiomati-
...
article.
                                               ...
                                               3
2     The classical probability algorithm
...
Unschärfe—as in Unschärfe-Prinzip or Unschärfe-Relation has come to be translated as
“uncertainty.” The primary dictionary definition of Unschärfe is “fuzziness” (followed
...
as 1/r 2 , and that the number of protons in a nucleus has an upper limit, then the stability
of ordinary material objects requires both the Heisenberg uncertainty principle and the
Pauli exclusion principle.)

                                             4
    What, then, is the proper—mathematically rigorous and philosophically sound—way
...
not subjective in this sense. As Mermin has pointed out, “quantum mechanics is the
                                              ...
                                              5
first example in human experience where probabilities play an essential role even when
...
Following Dirac, we denote a vector by the symbol |vi, and if the vectors {|ai i|i = 1, . . . , n}
form an orthonormal basis (ONB), we shall denote the components of |vi with respect to
this basis by hai |vi. Thus,
                                          X
                                    |vi =    |ai ihai |vi.                                     (1)
                                              i
...
we shall assume that V is complex. (If a real vector space turned out to be sufficient,
                                                  ...
                                                  6
it would be easy to appropriately constrain our conclusions.) We must therefore keep in
mind that hb|ai = ha|bi∗ . The advantage of Dirac’s notation is that it consolidates two
different ways of thinking about the expression |ai ihai |vi:

                               |ai ihai | |vi    =        |ai i hai |vi.                       (2)

hai | is a machine called covector, which accepts a vector |vi and returns a complex number,
the component hai |vi of |vi with respect to the basis vector |ai i. |ai ihai | is a machine called
projector, which accepts a vector |vi and returns another vector, the projection of |vi into
the 1-dimensional subspace containing |ai i. Think of the left-hand side of Eq. (2) as what
we do—projecting |vi into the 1-dimensional subspace containing |ai i—and of the right
hand side as what we get as a result: the basis vector |ai i multiplied by the component
of |vi with respect to |ai i.
...
vectors {|bk i|k = 1, . . . , m} such that (i) every vector in U can be written as a unique
...
an object O, composed of one positive and one negative charge, whose sole internal relative
                                                  ...
                                                  7
Figure 1: A fuzzy position, represented as a probability distribution, at two different
...
work, it would cause a decrease in ∆r, and O would collapse as a result. What is needed for
...
precision.
    To arrive at a formal definition of compatibility, we consider two elementary tests. We
                                              ...
                                              8
begin with a situation in which a particular outcome of the second test (say, the positive
...
of A represents the negative outcome.
     There are three possible combinations of outcomes: (i) M and N , (ii) M⊥ and N , and
...
mutually orthogonal, one can find a set of mutually orthogonal unit vectors B = {|ai i|i =
1, . . . , n} such that those with i = 1, . . . , j span M ∩ N , those with i = j + 1, . . . , k span
...
smallest subspace that contains both A and B.
                                                 ...
                                                 9
                   Figure 2: Two subspaces with commuting projectors.

   Let us translate this results into the language of projectors. It is readily seen that two
projectors M̂ and N̂ commute if and only if there is an ONB {|ai i|i = 1, . . . , n} such that
                             X                                     X
                     M̂ =            |ai ihai |   and      N̂ =            |ak ihak |.       (5)
                            some i                                some k

As an illustration we consider the following example:

                        M̂ = |2ih2| + |3ih3|,           N̂ = |1ih1| + |3ih3|.                (6)

If the vectors |1i, |2i, |3i belong to the same ONB (Fig. 2), commutability follows from
the orthonormality relations hai |ak i = δik . If at least one pair of vectors (say, |1i and |2i)
are not orthogonal, then

                M̂ N̂ = |2ih2|1ih1| + |3ih3|,           N̂ M̂ = |1ih1|2ih2| + |3ih3|.        (7)

This is to say that M̂ N̂ 6= N̂ M̂ (Fig. 3). Figure 4 illustrates the respective actions of
N̂ M̂ and M̂ N̂ on a vector |vi.

                                                   10
                Figure 3: Two subspaces with noncommuting projectors.
...
(or line) contained in either A or B is contained in A ∪ B, we have that
                        ...
                        [p(A) = 1 or p(B) = 1] =⇒ p(A ∪ B) = 1.                            (9)
                                              ...
                                              11
Figure 4: The situation illustrated in Fig. 3 seen from above, looking down the 3-axis.
Left: first |vi is projected into M (the subspace containing |2i), then the resulting vector
is projected into N (the subspace containing |1i). Right: first |vi is projected into N ,
...
hindsight we know that Nature concurs. (Contextuality turns out to be an inescapable
                                            ...
                                            12
Figure 5: The relations that hold between two subspaces M, N , their orthocomplements,
...
are different outcomes of the same measurement, then the corresponding projectors Â
and B̂ are orthogonal and their sum Â + B̂ is the projector corresponding to the outcome
A ∪ B. Our third axiom therefore reads:

Axiom 3 If Â and B̂ are orthogonal projectors, then the probability of the outcome
represented by Â + B̂ is the sum of the probabilities of the outcomes represented by Â
and B̂, respectively.
...
the projector P̂ is given by
                                     p(P̂) = Tr(ŴP̂),                                  (13)

                                             13
where Ŵ is a unique operator, known as density operator , which has the following prop-
erties:
                                    
   • Ŵ is linear : Ŵ α|ai + β|bi = α Ŵ|ai + β Ŵ|bi.
                                                 ∗
   • Ŵ is self-adjoint: ha|Ŵ|bi = hb|Ŵ|ai .

   • Ŵ is positive: ha|Ŵ|ai ≥ 0.

   • Tr(Ŵ) = 1.

   • Ŵ2 ≤ Ŵ.

Let us try to understand why Ŵ has these properties. If P̂ is a 1-dimensional projector
|vihv|, then the trace rule (13) reduces to p(P̂) = hv|Ŵ|vi. The self-adjointness of Ŵ
ensures that the probability hv|Ŵ|vi is a real number, and the positivity of Ŵ ensures
that hv|Ŵ|vi does not come out negative.
...
{|ak ihak ||k = 1, . . . , n}. Tr(Ŵ) = 1 ensures that the probabilities hai |Ŵ|ai i of these
outcomes add up to 1, and together with the positivity of Ŵ, it ensures that no proba-
bility comes out greater than 1.
    If the density operator is idempotent (Ŵ2 = Ŵ), then it is a 1-dimensional projector
|wihw| and it is called a pure state; |wi is the corresponding state vector (which is unique
up to a phase factor), and the trace rule simplifies to p(P̂) = hw|P̂|wi. (Since we began by
upgrading from a point in a phase space to a line in a vector space, we are not surprised to
find that a pure state projects into a 1-dimensional subspace.) If in addition P̂ = |vihv|,
the trace rule boils down to the familiar Born rule,

                               p(P̂) = hw|vihv|wi = |hv|wi|2.                            (14)

If Ŵ2 < Ŵ then Ŵ is called a mixed state. What shall we make of this possibility? Since
Ŵ is self-adjoint, there exists an ONB of eigenvectors |wk i of Ŵ with real eigenvalues λk
such that                                 nX
                                    Ŵ =         λk |wk ihwk |.                          (15)
                                           k=1

Ŵ2 < Ŵ is therefore equivalent to
...
to 1—recall that Tr(Ŵ) = 1—they have all the properties one expects from probabil-
ities associated with mutually exclusive and jointly exhaustive events. A mixed state,

                                                 14
therefore, defines probability distributions over probability distributions. It contains less
...
9      How probabilities depend on measurement
       outcomes
The trace rule tells us how to extract probabilities from a density operator Ŵ. Our next
order of business is to find Ŵ. Suppose that Ŵ1 is the density operator appropriate for
...
represented by the projector P̂ is obtained. What is the density operator Ŵ2 appropriate
...
surements repeatable. Accordingly, Ŵ2 must satisfy the following conditions:
    1. It is constructed out of Ŵ1 and P̂.

    2. It is self-adjoint.

    3. Tr(Ŵ2 P̂) = 1.

    4. Tr(Ŵ2 P̂⊥ ) = 0, where P̂⊥ is any possible outcome of M other than P̂.
The first and the fourth condition are satisfied by Ŵ1 P̂, P̂Ŵ1 , and P̂Ŵ1 P̂. Since Ŵ1 P̂
and P̂Ŵ1 are not self-adjoint unless Ŵ1 and P̂ commute, only P̂Ŵ1 P̂ also satisfies the
second condition. To satisfy the third condition as well, all we have to do is divide by
Tr(Ŵ1 P̂) = Tr(P̂Ŵ1 ) = Tr(P̂Ŵ1 P̂). Thus,
                                                P̂Ŵ1 P̂
                                       Ŵ2 =              .                              (17)
                                               Tr(Ŵ1 P̂)
Now suppose that M is a maximal test, and that P̂ = |wihw|. Then
                             |wihw|Ŵ1|wihw|       hw|Ŵ1|wi
                    Ŵ2 =                    = |wi           hw| = |wihw|.               (18)
                              Tr(Ŵ1 |wihw|)       hw|Ŵ1|wi
...
this case Ŵ2 is independent of Ŵ1 .

                                               15
10      How probabilities depend on the times
        of measurements
The above definition of repeatability is nonstandard in that it requires Ŵ2 to be inde-
...
the actual outcome of M2 .
    If the two measurements are maximal tests, then there are two ONBs, {|ai i} and
{|bk i}, such that the projectors {|aiihai |} represent the possible outcomes of M1 and the
projectors {|bk ihbk |} represent the possible outcomes of M2 . The two bases are related
by a unitary transformation: |bk i = Û |ak i. In the absence of time-dependent boundary
conditions, Û depends on the time difference ∆t21 = t2 − t1 but not, in addition, on t1
or t2 . If we imagine a third maximal test M3 with outcomes {|ci ihci |}, which verifies the
outcome of M2 , we have |ck i = Û(∆t32 ) |bk i and thus

                               |ck i = Û(∆t32 ) Û(∆t21 ) |ak i.                      (19)

If we omit the second test, M3 verifies M1 directly (rather than indirectly, by verify-
ing M2 ), and we have that

                                |ck i = Û(∆t32 + ∆t21 ) |ak i.                        (20)

Hence
                           Û(∆t32 + ∆t21 ) = Û(∆t32 ) Û(∆t21 ).                     (21)
For every unitary operator Û there is a self-adjoint operator Â such that Û = eiÂ , the
exponential being defined by its Taylor expansion. Equation (21) is therefore equivalent
to
                           eiÂ(∆t32 +∆t21 ) = eiÂ(∆t32 ) eiÂ(∆t21 ) .               (22)
But we also have that

                          eiÂ(∆t32 ) eiÂ(∆t21 ) = ei[Â(∆t32 )+Â(∆t21 )] ,          (23)

as one can check by expanding both sides in powers of Â and comparing coefficients. It
follows that Â depends linearly on ∆t:

                         Â(∆t32 + ∆t21 ) = Â(∆t32 ) + Â(∆t21 ).                     (24)

                                                  16
This allows us to introduce a self-adjoint operator Ĥ, known as the Hamilton operator or
simply the Hamiltonian, satisfying

                                        Û(∆t) = e−(i/h̄) Ĥ ∆t .                            (25)

(The choice of the negative sign and the inclusion of the reduced Planck constant h̄ are
of historical rather than physical interest.) For infinitesimal dt we then have

                                      Û(dt) = 1̂ − (i/h̄) Ĥ dt.                            (26)

If the boundary conditions are time-dependent, then Û(dt) also depends on t, which means
that Ĥ depends on t. If Ŵ(t1 ) = |wihw|, then Ŵ(t2 ) = |w ′ihw ′ | with |w ′ i = Û(∆t21 ) |wi.
For infinitesimal ∆t21 we therefore have that
                                                  d
                                            ih̄      |wi = Ĥ |wi.                           (27)
                                                  dt

Introducing (basis-dependent) matrix elements Hik = hai |Ĥ|ak i and vector components
wi = hai |wi, we obtain
                                    dwi X
                                ih̄     =    Hik wk ,                             (28)
                                     dt   k
...
finitesimal space intervals, Ĥ may contain differential operators with respect to x.
...
phenomena in considerable depth and without much further mathematical ado.
                                                         ...
                                                         17
Premise a Quantum mechanics provides us with algorithms for assigning probabilities
...
two probabilities. Accordingly, the corresponding amplitude is the product hD|LihL|Gi
of two amplitudes. Symmetry considerations then lead to the conclusion that for a free
particle the amplitude hx|yi can only depend on the distance d between x and y, and
geometrical considerations lead to the conclusion that the absolute square of hx|yi is in-
verse proportional to d2 . The multiplicativity of successive propagators, finally, implies

                                             18
the additivity of their phases, whence once deduces that the phase of hx|yi is proportional
...
In other words, first take the absolute squares of the amplitudes Ai = hw|vi ihvi|ui and
then add the results.
   If no intermediate measurement is made, we have pB (w|u) = |hw|ui|2, and if we insert
the identity operator 1̂ = i |vi ihvi |, we have
                           P

                                                                    2
                                pB (w|u) = |       i hw|vi ihvi |ui| .                    (33)
                                               P
...
systems. We begin with two independent systems, one associated with the vector |ai
from a vector space V1 , the other associated with the vector |bi from another vector
...
of measurements to which the other system can be subjected.)
    Considered as a pair |a, bi, the two vectors belong to the direct product space V1 ⊗ V2 .
...
the systems in possession of the respective properties c and d is
                         p(c, d|a, b) = p(c|a) p(d|b) = |hc|aihd|bi|2.                    (34)

                                               19
Using the inner product on the direct product space, defined by hc, d|a, bi = hc|aihd|bi,
we have
                              p(c, d|a, b) = |hc, d|a, bi|2.                        (35)
Not every vector in V1 ⊗ V2 can be written in the form |a, bi. A generic vector in this
space has the form |V i = i k cik |ai , bk i, where {|ai i} and {|bk i} are ONBs in V1 and
                            P P

V2 , respectively. It is, however, always possible to find a pair {|Aii}, {|Bk i} of ONBs
such that |V i becomes a single sum
                                               X
                                      |V i =        Ci |Ai , Bi i                            (36)
                                               i
...
atom’s emergence from the slit plate, has the form
                               ...
                               |VESW i = √ |L, λi + |R, ρi ,                                 (37)
                                          2
where |Li, |Ri, |λi, and |ρi stand for the following measurement outcomes: atom went
...
outcomes P̂a and P̂γ in measurements performed on the component systems equals
     1h               ih         ih                 i
       hL, λ| + hR, ρ| P̂a ⊗ P̂γ |L, λi + |R, ρi =                                            (38)
     2
     1h                                                                                         i
       hL|P̂a |Lihλ|P̂γ |λi + hR|P̂a |Rihρ|P̂γ |ρi + hL|P̂a |Rihλ|P̂γ |ρi + hR|P̂a |Lihρ|P̂γ |λi .
     2
Set P̂a equal to either |LihL| or |RihR| and P̂γ equal to either |λihλ| or |ρihρ|, and find
...
remains unexamined, then P̂γ = 1̂, so that Eq. (38) reduces to
                                         1h                       i
                             p(P̂a ) =     hL|P̂a |Li + hR|P̂a |Ri .                         (39)
                                         2
The trace rule p(P̂a ) = Tr(Ŵa P̂a ) now tells us that
                                          1h               i
                                 Ŵa =      |LihL| + |RihR| ,                                (40)
                                          2
a mixed state. The probability of finding the atom at D is thus
                                   1h                                       i
              hD|ÛŴa Û† |Di =     hD|Û|LihL|Û† |Di + hD|Û|RihR|Û† |Di ,               (41)
                                   2
                                                   20
where Û is the unitary operator that takes care of the time difference between the (unper-
...
nothing but the probability |hL|Û|Si|2 = |hR|Û|Si|2 of either intermediate measurement
outcome (given that the atom passes the slit plate). This allows us to write
                                                            2                         2
                   p(D|S) = hD|Û|LihL|Û|Si + hD|Û|RihR|Û|Si ,                              (42)

which is indeed what we get using Rule A.

13      Propagator for a free and stable scalar particle;
        meaning of mass
Imagine making m intermediate position measurements at fixed intervals ∆t. The possible
outcomes of each measurement are n mutually disjoint regions Rk , a partition of space.
Under the conditions stipulated by Rule B, the propagator hB|Û|Ai now equals the sum
of amplitudes
                 n
                 X              n
                                X
                         ···            hB|Û|Rk(m) i · · · hRk(2) |Û|Rk(1) ihRk(1) |Û|Ai.   (43)
                k(1)=1         k(m)=1
...
a complex number Z[C],                        Z
                                           hB|Û|Ai =       DC Z[C].                           (44)

(We use square brackets to indicate that Z is a functional, which assigns numbers to
functions, in this case spacetime paths.) As it stands, the path integral DC is just the
                                                                             R
...
find that the only variable that dC can depend on is the proper time interval
                               q                                                q
                    ds =         dt2 − (dx2 + dy 2 + dz 2 )/c2 = dt 1 − v 2 /c2 .              (45)
...
travels from A to B via C. Integrating hB|Û|Ai (as a function of rB ) over the whole of
...
still exists at the time tB . For a stable particle this equals 1:
                   Z
                                                 2
                                                         Z            Z            2
                       d3 rB hrB , tB |Û|rA , tA i =        d 3 rB       DC ez s[C] = 1.   (48)
...
not something that actually happens.) It is customary
   ...
   • to multiply by 2π (so we may think of b as the rate at which the clock “ticks”—the
     number of cycles it completes each second): Z = e−i 2π b s[C] ,

   • to divide by Planck’s constant h (so b is measured in energy units and called the
     rest energy of the particle): Z = e−i(2π/h) b s[C] = e−(i/h̄) b s[C] ,

   • and to multiply by c2 (so b is measured in units of mass and called the particle’s
                                 2
     rest mass): Z = e−(i/h̄) b c s[C] .
...
are two rods, initially in the same place and equally long, still equally long when they
                                                 ...
                                                 22
meet after having traveled along different spacetime paths? Because the meter is defined
...
factor: Z[C] = e(i/h̄)S[C] . We divided by h̄ to let the action S[C] have its conventional
...
are then 4-vectors, so their inner product
                                     ...
                                     − E dt + p · dr = dS                                  (53)
                                                 ...
                                                 23
is a 4-scalar, as it should be. These definitions hold for particles that follow well-defined
paths, including the alternatives contributing to the path integral (44).
    For a free particle we have
                                                                       q
                           dS = −mc2 ds = −mc2 dt 1 − v 2 /c2 .                                 (54)
...
not only homogeneous but also linear in dt and dr:
                               q
                dS = −mc2 dt 1 − v 2 /c2 − qV (t, r) dt + (q/c)A(t, r) · dr.                    (55)
...
root in Eq. (55) to first order in v 2 /c2 :
                                   q                 1 v2
                                       1 − v 2 /c2 ≈ 1 −  .                           (56)
                                                     2 c2
...
and we choose a particle of unit charge (q = 1). We thus have
                                                       Z           h                        i
                                   2
                     S[C] = −mc (tB − tA ) +                   dt mv 2 /2 − V (t, r) .          (57)
                                                           C

The path-independent term can be dropped, for all it contributes to the propagator
hB|Û|Ai is an irrelevant overall phase factor. Hence
                                            Z                  R           2
                          hB|Û|Ai =            DC e(i/h̄) C dt[mv /2−V (t,r)] .                (58)

It is customary to introduce a “wave function” ψ(t, r) such that
                                       Z
                      ψ(rB , tB ) =        d3 rA hrB , tB |Û|rA , tA i ψ(rA , tA ).            (59)

Feynman [33, 34] has shown how to get from here to the Schrödinger equation
                                  h̄2           ∂2ψ ∂2ψ ∂2ψ
                                                                               !
                            ∂ψ
                        ih̄    =−                   + 2 + 2                        + V ψ.       (60)
...
only students—tend to accept them as ultimate encapsulations of the way things are.
  ...
  1. The first standard axiom typically tells us that the state of a system S is (or is
     represented by) a normalized element |vi of a Hilbert space HS . (Weinberg [35] is
  ...
  2. The next axiom (or couple of axioms) usually states that observables are (or are
     ...
     of a measurement of an observable Ô are the eigenvalues of Ô.
  ...
  3. Then comes an axiom (or a couple of axioms) concerning the time evolution of
     ...
     Ô is measured, the subsequent state of S is the eigenvector corresponding to the
  ...
  5. Finally there is an axiom (or a couple of axioms) concerning probabilities. If S
     is in the state |vi and we do an experiment to see if it has the property |wihw|,
     then the probability p of a positive outcome is given by the Born rule p = |hw|vi|2.
     Furthermore, the expectation value of an observable Ô in the state |vi is hv|Ô|vi.
...
understood as a straightforward way of making room for nontrivial probabilities. Because
                                              ...
                                              25
the probabilities assigned by the points of a phase space are trivial, the classical formalism
...
|vihv| represents the outcome of a maximal test for the purpose of assigning probabilities
to the possible outcomes of whichever measurement is subsequently made, and if |wihw|
represents a possible outcome of this measurement for the purpose of assigning to it a
probability, then the probability of this outcome is Tr(|vihv|wihw|) = |hw|vi|2. If the
Hamiltonian is not zero, a unitary operator has to be sandwiched between hw| and |vi.
...
tum states. |v(t)i is not an instantaneous state of affairs that obtains at the time t. It is
...
function giving the ‘state of the system’ between measurements” [36]. |v(t)i is an algo-
...
axioms), at which point we learn that the expectation value of an observable Ô in the
state |vi is hv|Ô|vi. This expectation value (whose probability, incidentally, can be 0) is
nothing but the mean value k Ok |hOk |vi|2. So what does Ô qua operator have to do
                               P

with it? If we define a self-adjoint operator Ô = k Ok |Ok ihOk |, where the projectors
                                                     P

|Ok ihOk | represent the possible outcomes Ok (for the purpose of assigning probabilities
to these outcomes), then the expectation value can be written as hv|Ô|vi. Because Ô
...
by) self-adjoint operators.
                                             ...
                                             26
    And finally, why would the states of composite systems be (represented by) vectors in
...
any kind.
                                             ...
                                             27
 [1] R P Feynman, R B Leighton, and M Sands, The Feynman Lectures in Physics, Vol. 1
     (Addison-Wesley, Reading, 1963) p. 1–2

 [2] R P Feynman, QED: The Strange Theory of Light and Matter (Princeton University
     Press, Princeton, 1985) p. 12

 [3] G W Mackey, The mathematical Foundations of Quantum Mechanics (Benjamin,
     New York, 1963)

 [4] V Varadarajan, Geometry of Quantum Theory (Springer, New York, 1968)

 [5] G Ludwig, Foundations of Quantum Mechanics, Vols. I and II (Springer, New York,
     1983, 1985)

 [6] I Pitowsky, Quantum Probability–Quantum Logic, Lecture Notes in Physics 321
     (Springer, Berlin, 1989)

 [7] E H Lieb, Rev. Mod. Phys. 48, 553 (1976)

 [8] J S Bell, in 62 Years of Uncertainty, edited by A I Miller (Plenum, New York, 1990),
     p. 17

 [9] N D Mermin, Am. J. Phys. 66, 753 (1998)

[10] H Primas, Mind and Matter 1, 81 (2003)

[11] J M Jauch, Foundations of Quantum Mechanics (Addison-Wesley, Reading, 1968),
     pp. 92–94, 132

[12] R P Crease, Physics World, 19 (September 2002)

[13] R P Feynman, R B Leighton, and M Sands, The Feynman Lectures in Physics, Vol. 3
     (Addison-Wesley, Reading, 1965), Secs. 1–1 to 1–6

[14] G Greenstein and A Zajonc, The Quantum Challenge: Modern Research on the
     Foundations of Quantum Mechanics (Jones and Bartlett, Sudbury, 1997), Chap. 1

[15] C Jönnson, Am. J. Phys. 42, 4 (1974)

[16] A Tonomura, J Endo, T Matsuda, T Kawasaki, and H Ezawa, Am. J. Phys. 57, 117
     (1989)

[17] M O Scully, B-G Englert, and H Walther, Nature 351, 111 (1991)

[18] B-G Englert, M O Scully, and H Walther, Sci. Am. 271, 56 (1994)

                                             28
[19] U Mohrhoff, Am. J. Phys. 67, 330 (1999)

[20] U Mohrhoff, Am. J. Phys. 69, 864 (2001)

[21] A Peres, Quantum Theory: Concepts and Methods (Kluwer, Dordrecht, 1995),
     Chap. 7

[22] N D Mermin, Rev. Mod. Phys. 65, 803 (1993)

[23] R Clifton, Am. J. Phys. 61, 443 (1974)

[24] A Peres, Quantum Theory: Concepts and Methods (Kluwer, Dordrecht 1995), p. 190

[25] A M Gleason, J. Math. Mech. 6, 885 (1957)

[26] I Pitowsky, J. Math. Phys. 39, 218 (1998)

[27] R Cooke, M Keane, and W Moran, Math. Proc. Camb. Phil. Soc. 98, 117 (1985)

[28] C A Fuchs, in Decoherence and its Implications in Quantum Computation and In-
     formation Transfer edited by A Gonis and P E A Turchi (IOS Press, Amsterdam,
     2001), pp. 38–82

[29] P Busch (2003), Phys. Rev. Lett. 91, 120403

[30] C Caves, C A Fuchs, K Manne, and J M Rennes, Found. Phys. 34, 193 (2004)

[31] A Peres, Quantum Theory: Concepts and Methods (Kluwer, Dordrecht, 1995), Sec. 9–
     5

[32] A Peres, Quantum Theory: Concepts and Methods (Kluwer, Dordrecht, 1995), Sec. 5–
     3

[33] R P Feynman and A R Hibbs, Quantum Mechanics and Path Integrals (McGraw-Hill,
     New York, 1965)

[34] D Derbes, Am. J. Phys. 64, 881 (1996)

[35] S Weinberg, The Quantum Theory of Fields, Vol. 1 (Cambridge University Press,
     Cambridge, 1996), pp. 49–50

[36] A Peres, Am. J. Phys. 52, 644 (1984)

[37] U Mohrhoff, Pramana–J. Phys. 64, 171 (2005)

[38] U Mohrhoff, Int. J. Q. Inf. 2, 201 (2004)
