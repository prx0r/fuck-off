...
**file:** QB_Salzburg_jedlicka
---

             Dr. Senckenbergische Anatomie
        J.-W. Goethe Universität, Frankfurt am Main

Quantum stochasticity and neuronal
         computations

             Peter Jedlička, MD
                              Definition

A stochastic system is one whose behavior is indeterministic in that its inputs
and initial state do not fully determine its next state (output)

   • The only intrinsically (objectively) stochastic (indeterministic)
     processes in physical world are quantum processes

   • Does quantum indeterminism affect the dynamics of neuronal
     networks? Is our brain a deterministic machine or an indeterministic
     system?
1. Criticism of quantum brain hypothesis

2. Two ways of taking advantage of quantum events in biology
...
A. neurons and neural networks are too large for quantum phenomena to play a
    ...
    “Most biologists think that quantum effects all just cancel out in the brain.”
                                                       Daniel Dennett
...
degrees Kelvin tissue strongly coupled to its environment - display
...
1.   quantum dynamics speeds up and modulates the computational processes at
     microscopic and mesoscopic levels for which quantum effects are directly
     present
...
2.   because the brain is a complex nonlinear system, capable of chaotic
     dynamics, it can amplify lowest scale quantum fluctuations upward,
     modulating larger-scale macroscopic activity patterns
                        Quantum enzymology

• empirical evidence shows that biomolecules (proteins, DNA) take direct
...
protein folding (even in a warm and noisy intracellular environment!)
         quantum tunneling effects are involved in the conformational
...
3. the excitation is trapped in a reaction centre, where its remaining energy is
   used to produce energy-rich carbohydrates
...
conditions
   ...
   • In iterative hierarchies with nonlinear dynamics (prone to chaos), small
   (even infinitesimal) fluctuations are not averaged away, they can be
   amplified!
...
•     Paradoxically, quantum effects stabilize the behavior of (classically) chaotic
      systems
•     At finite temperatures, quantum coherence can create new patterns at a
      mesoscopic scale
•     Quantum chaotic systems can exhibit persistent „fuzzy“ regular patterns
                              Summary I

1. Quantum effects are directly present at microscopic and mesoscopic levels
...
hierarchy of nested networks with many feedback loops amplifies the
quantum events
...
Synaptic transmission in the central nervous system has a stochastic character:

• when an action potential invades the presynaptic terminal there is a low release
  probability (20%)

    vesicular neurotransmitter release as a random Poisson-like process
...
• Stochastic modeling of transmitter release can account for the synaptic
...
• In the PSD they can be stabilized by binding to scaffolding proteins
...
• E.g., a 50 nm calcium concentration in a dendritic
  ...
  changes)  60 free ions                          Franks & Sejnowski, Bioessays 2002
...
• self-similar, scale-free structure
• functional modules (amplifiers, filters, switches, oscillators, etc.)
• stochastic events
Network of interacting proteins/genes is a dynamic
system
State: a point in a multidimensional system
Change: vectors defined by kinetic equations
...
Biochemical regulation at the nanomolar scale: it‘s a noisy business!
    • Stochastic genetic expression has been observed directly (intrinsic vs.
      extrinsic noise)

    • Molecular stochastic fluctuations play an important role in
      determining cellular functions by inducing spontaneous state
      transitions (e.g. in a bistable molecular LTP/LTD switch in synaptic
      plasticity )

    • A theory combining cellular regulatory modules and stochastic
      dynamics is emerging

    • Nonintuitive cellular/organismal responses driven by molecular
      fluctuations  powerful new signaling and regulatory modes
...
• Interaction of stochasticity with nonlinearities leads to novel and even
...
Neuronal computations are inherently stochastic at all levels:
...
„Membrane voltage is the product of interactions at the atomic level,
many of which are governed by quantum physics.

… interactions between action potentials and transmitter release as
