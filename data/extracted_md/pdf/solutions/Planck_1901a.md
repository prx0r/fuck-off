...
plish this it is necessary to look more deeply into the meaning of the concept of entropy. Consideration
  ...
  3 H. Beckmann, Inaugural dissertation, Tübingen 1898. See also H. Rubens, Weid. Ann. 69 (1899) p. 582.
...
where P represents a large integer generally, while the value of  is yet uncertain.
           ...
           Es kommt nun darauf an, die Wahrscheinlichkeit W dafür zu finden, dass die N Res-
       onatoren insgesamt die Schwingungsenergie UN besitzen. Hierzu ist es notwendig, UN nicht
       als eine stetige, unbeschränkt teilbare, sondern als eine discrete, aus einer ganzen Zahl von
       endlichen gleichen Teilen zusammengesetzte Grösse aufzufassen. Nennen wir einen solchen
