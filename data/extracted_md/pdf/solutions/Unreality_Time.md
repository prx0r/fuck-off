...
---
            ...
            A QUARTERLY REVIEW
                              OF
                                                                   ...
                                                                   Downloaded from http://mind.oxfordjournals.org/ at Harvard Library on December 21, 2016
...
itself apart from mysticism for any long period, and almost
 ...
 in this paper.
                               31
 458                 j . ELLIS MCTAGGABT:

     Positions in time, as time appears to us primd facie, are
...
the conscious beings in it) would be a timeless universe.
...
in a time series, and has always had one.1 That is, it will
...
that M has ceased and N begun, but that it is M which has
  1
    It is equally true, though it does not concern us on the hypothesis
...
Thus one event cannot change into another.
   Neither can the change be looked for in the numerically
                                                                   ...
                                                                   Downloaded from http://mind.oxfordjournals.org/ at Harvard Library on December 21, 2016
different moments of absolute time, supposing such moments
to exist. For the same arguments will apply here. Each
such moment would have its own place in the B series,
since each would be-jearlier or later than each of the others.
...
last moment—the event in question will still h* a death of
an English Queen. And in every respect but on* it is equally
devoid of change. But in one respect it does change. It
...
                     THE UNREALITY OF TIME.                         461

only a change of the characteristics imparted to events by
...
would lot be completely the same, if—as I believe to be the

                                                                           Downloaded from http://mind.oxfordjournals.org/ at Harvard Library on December 21, 2016
case—the relation of X to Y involves      the existence in X of
a quality of relationship to Y.1 Then there would be two
...
minations which gives time. But this other series—let us
  1
    1 am not asserting, as Lotze did, that a relation between X and Y
consists of a quality in X and a quality in Y—it view which I regard as
...
that P is earliest and M latest). And there is nothing either
...
                       THE UNREALITY OF TIME.                             463
 ...
 Bill, or from the Eeform Bill to the Great Charter. But in
...
which will be present is Future.1 Thus to our previous con-
...
scribe them, but they cannot be denned. We can only show
...
given a C • series of permanent relations of terms, which is
   1
     This account of the nature of the A series is not valid, for it involves-
...
464                 J. ELLIS MCTAGGABT:

not in itself temporal, and therefore is not a 6 series, and
given the farther fact that the terms of this C series also
...
illusion due to the way in whi'jh we perceive it. Most phil-
osophers, whether they did or did not believe time to be true
of reality, have regarded the distinctions of the A series as
essential to time.
...
A series would irfvolve the unreality of time.
                   THE UNREALITY OF TIME.                      465
...
in the A series. If it i& believed to be in time, it is believed
466                J. ELLIS MCTAGGART :
...
all real, while the distinction of past, present, and future
...
But then no time would be Die. time—it would only be the
...
or a moment. 1 The other term must be something outside
...
and in the past.
   1
     It has been maintained that the present is whatever is simultaneous
with the assertion of ite presentness, the future whatever is later than
...
already reached.
468                J. ELLIS MCTAGGABT:

   The relations which form the A series then must be rela-
tions of events and moments to something not itself in the
time-series. What this something is might be difficult to
say. But, waiving this point, a more positive difficulty
presents itself.
...
simultaneous, and there is no contradiction to this in the
...
my writing of this article has the characteristics of past,
...
tfian as a vicious circle. If we avoid the incompatibility of
...
changing the first for the second, and the second for the
third ?
...
470                      J. ELLIS MCTAGGART:

the same fallacy   would have been committed as in the pre-
 vious case.1
...
remove this contradiction that the explanation was suggested
   ...
   ' I t is very usual to present Time under the metaphor of a spatial
movement. But is it to be a movement from past to future, or from future
 to past 1 If the A series is taken as one of qualities, it will naturally be
...
                  THE UNREALITY OF TIME.                   471

that the characteristics belong to the terms successively.
...
just discovered in the application of the A series to reality,
...
from distinctions in our own experience.
    At any moment I have certain perceptions, I have also the
...
472                 J. ELLIS MCTAGGABT :

now fall within my " specious present". Of those which
...
perception Q and Y's perception E. At a certain moment Q
...
primd facie to give knowledge of reality. But we now see
...
ceive as events in a time-series do really form a non-temporal
...
view, according to which they really do form a C series, is the
 ...
 series, though it is not a temporal series.
                                32
474     J. ELLIS MCTAGGABT: THE UNBEALITY OP TIME.
 ...
 distorted reflexion, of something in the real nature of the
...
with the appearance itself ? If we reduce time and change
 ...
 and which is in time, and is not time, then, shown to be real
