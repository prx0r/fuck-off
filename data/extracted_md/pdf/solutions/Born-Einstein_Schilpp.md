...
**file:** Born-Einstein_Schilpp
---

        EIN STEIN ’S STATISTICAL THEORIES

      N E of the most remarkable volumes in the whole of scien­
       tific literature seems to me Vol. 17 (4th series) of A nnalen
...
tivity—an assumption for which I have to apologise, as it is
...
fundamental problems of the time.
   H ere I propose to discuss Einstein’s contributions to statis­
tical methods in physics. H is publications on this subject can
...
Einstein’s philosophy of science. H e has seen more clearly than
...
a tragedy—for him, as he gropes his way in loneliness, and for
                                    163
164                                MAX BORN
us who miss our leader and standard-bearer. I shall not try to
...
Thermodynamik”1 is a remarkable example of the fact that
...
Maxwell and Boltzmann came near to it. W illard Gibbs is
...
velocities, which can be represented as a point in a 2«-dimen-
sional “ phase-space;” the energy is given as function of these
 ...
 the following year, entitled “ Eine Theorie der Grundlagen der
 Thermodynamik,”2 Einstein builds the theory on another basis
 not used by Gibbs, namely on the consideration of a single sys­
 tem in course of time (later called “Zeit-Gesammtheit” time
  1 Annalen der Physik (4 ) , 9, p. 477, (1 9 0 2 ).
  * Annalen der Physik (4 ) ,       p. 170, (1 9 0 3 ).
           EINSTEIN’S STATISTICAL THEORIES                            165

assembly), and proves that this is equivalent to a certain virtual
...
lish by A. D. Cowper.3 In the first paper (1905) he sets out to
...
for the treatment of all of them. H e regards the movement ^
...
one. The logical clue to the understanding of the phenomenon
 ...
 on it, is unobservable; the visible effect in a finite interval of
  'Investigations on the Theory of the Brownian M ovem ent; Methuen & Co.,
London, (1926).
166                      MAX BORN
time t consists of irregular displacements, the probability of
...
the mean square of the displacement divided by 2T . In this
...
and of the number of molecules in a gramme-molecule (Avo-
gadro’s number TV). By its simplicity and clarity this paper is
...
“irregular motion of suspended particles” predicted by him is
...
/       (        E IN S T E IN ’S S T A T IS T IC A L T H E O R IE S   167

    of photo-luminescence, photo-ionisation) in terms of light-
    ...
    are central and by far more important than any other law. H e
    ...
    be more evident. H e shows how one can obtain the entropy S
    ...
    thermodynamic probability W
                               S = k log W
    where k is the gas constant per molecule, for determining W .
    ...
    tions;4 although this is of considerable practical importance,
      * Annalen der Physik ( 4 ) , ig , p. 373, ( 1 9 0 6 ) .
i68                          MAX BORN
...
ent quanta of energy of size and number n = E /h v . It is ob­
...
Einstein’s gift for intuiting such correlations was almost uncanny.
...
strange was happening. H is work at that period was essentially
...
work on specific heat.5 It started again with a theoretical con­
sideration of that type which provided the strongest evidence
in Einstein’s mind, namely on statistics. H e remarks that
...
W arme,” Annalen der Phystk (4 ) , 22, p. 180, (1 907).
           EINSTEIN’S STATISTICAL THEORIES                      169
    Now if this is so, the quantum is not a feature of radiation
...
energy should carry the same average energy, namely Yi R T
...
degree of temperature should be 6 X Y zR T , or 5.94 calories.
...
heat higher than the Dulong-Petit value—but that is not always
...
    170                       MAX BORN
    quencies of the oscillators. H igh frequency oscillators like the
...
$
    ...
    a ll; it is the abstract “normal mode,” well known from ordi­
...
           EINSTEIN’S STATISTICAL THEORIES                           171
    The first of these two investigations has again to do with
the law of radiation and statistics.6There are two ways of tackling
...
and Waage; here again the elementary mechanism is provided                 a/
...
             7)ij{
                          ...
                          MAX BORN
The decay constant seemed to be an invariable property of the
...
an atom, say the lowest state i and an excited state 2. Einstein
assumes that if an atom is found to be in the state 2 it has a
certain probability of returning to the ground state I, emitting
a photon of a frequency which, according to the quantum law,
corresponds to the energy difference between the two states}
i.e. in a big assembly of such atoms the number of atoms in state
2 returning to the ground state I per unit time is proportional
...
ability for the reverse process I -» 2 which represents absorp­
tion of a photon of frequency v12 and is proportional to the
...
sion process 2 -» I, “induced emission,” which again has a prob­
ability proportional to the radiation density for vi2.
...
of the transition probabilities. Einstein has connected it with
...
a dart-like behaviour of the quanta. H ere we are not concerned
...
               EINSTEIN’S STATISTICAL THEORIES                     173
   causal, indeterministic reasoning. O f course, I am sure that
 ...
 J only because of our incomplete knowledge of the pre-history
 / of the atom. Yet the fact remains that he has initiated the
 I spreading of indeterministic statistical reasoning from its
...
I Einstein’s discovery of the equality of up- and down-ward
I transition probabilities.
   ...
   ideal gases.7 In this case the original idea was not his but came
   from an Indian physicist, S. N. Bose; his paper appeared in a
   translation by Einstein8 himself who added a remark that he re­
   ...
   ference that these particles are not distinguishable. H e does not
   distribute individual particles over a set of states, but counts
    1 Berl. Ber. 1924, p. 261, 1925, p. 318.
    # S. N. Bose, Zeitschrijt fu r Physik, 26, 178, (1 924).
      *74                        MAX BORN
      the number of states which contain a given number of particles.
...
s'    this theory is called “ gas degeneracy.” Einstein’s papers ap-
    v peared just a year before the discovery of quantum mechanics;
      ...
      famous paper.9 It was the same remark of Einstein’s which a
...
P '— this represents clearly only one state and has to be counted once.
      ...
      are more metaphysical than physical, the use of a symmetric
       ...
       able. This way of thinking has morover led to the other case of
         ’ “Quantisierung als Eigenwertproblem,” Annalcn der Physik ( 4 ) , 70, p. 361,
       <19*6)5 «. p. 373.
              EINSTEIN’S STATISTICAL THEORIES                        175
gas degeneracy, discovered by Fermi and Dirac, where the
...
H is following work in this line, though of great importance
by stimulating thought and discussion, was essentially critical.
H e refused to acknowledge the claim of quantum mechanics
...
of his philosophy forbids him to follow it to the end. W hat is
this principle?
   Einstein’s philosophy is not a system which you can read in
a book 5 you have to take the trouble to abstract it from his
papers on physics and from a few more general articles and
pamphlets. I have found no definite statement of his about
the question “W hat is Probability?” ; nor has he taken part in
...
nature just like any scientific device. H e has certainly very
...
obituary article on Ernst Mach:10
...
acquire such an authority over us that we forget their human origin
  10Phys. Zeitschr. 17, p. 101, (1 9 1 6 ).
176                          MAX BORN
and accept them as invariable. Then they become “necessities of
thought,” “given a ■priori,” etc. T he path of scientific progress is then,
...
stand like rock. W hat he is aiming at is a general field-theory
...
of quantum statistics 5 it is still we mortals who are playing
...
               E IN S T E IN ’S S T A T IS T IC A L T H E O R IE S        177

   Einstein’s dislike of modern physics has not only been ex­
...
published in collaboration with Podolsky and Rosen.11 That
...
of logic itself. H e introduces a three-valued logic, in which
apart from the truth-values “ true” and “ false,” there is an
intermediate one, called “indeterminate,” or, in other words, he
rejects the old principle of “tertium non d a t u r as has been
...
M y attitude to statistics in quantum mechanics is hardly affected
...
in spite of this, he remains my beloved master.
                                                             M ax B o rn
  D epa r t m e n t of M a t h e m a t ic a l P hysics
  U n iversity of E dinbu rg h
  E d in bu rg h , Scotland

   11 A. Einstein, B. Podolsky, N. Rosen: “ Can Quantum Mechanical Description
of Physical Reality be Considered Complete?” Phys. Rev. 47, p. 777, (1 935).
