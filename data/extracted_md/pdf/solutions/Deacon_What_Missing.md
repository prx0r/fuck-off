...
**file:** Deacon_What_Missing
---

                                                                 University of California, Berkeley

                           8
                           What is missing from theories
                           of information?

                          Theories of information that attempt to sort out problems con-
                   cerning the status and efﬁcacy of its content – as it is understood
                   ...
                   is exactly the opposite: its absence. But how is it possible for a speciﬁc
                   absence to have deﬁnite causal consequences? A crucial clue is provided
                   ...
                   is dependent on a relationship to something that is speciﬁcally not
                   ...
                   informative because it indicates the absence of some speciﬁc form of                    123

9780521762250c08_p123-142.indd 123                                                                     4/26/2010 4:23:52 PM
         124          Terrence W. Deacon

                      extrinsic inﬂuence. Both conditions are determined with respect to a
                      potential inﬂuence on the form of the semiotic medium that is extrin-
                      ...
                      tion is deﬁned. Moreover, I will argue that a process capable of inter-
                      preting the reference implicit in such signal constraints depends on
                      coupling the context-dependent signal generation process to a speciﬁc
                      ...
                      ﬁnd ourselves guarding, sharing, or selling information. The import-
                      ...
                      ogy with molecular biology has spawned an entirely new ﬁeld, dubbed
                      bioinformatics, that promises radical new medical technologies and

9780521762250c08_p123-142.indd 124                                                             4/26/2010 4:23:52 PM
                                                 What is missing from theories of information?       125

                   unprecedented threats to privacy. Even household users of internet
                   ...
                   with a set of assumptions about information that are just barely sufﬁ-
                   cient to handle the tracking of its most minimal physical and logical
                   attributes, but which are insufﬁcient to understand either its deﬁning
                   ...
                   concept of “patriotism.” Despite the fact that there is no speciﬁc phys-
                   ...
                   to clarify, even though the exploitation of energy was a deﬁning fea-
                   ture of that era. The concept was ultimately demystiﬁed by recogniz-
...
9780521762250c08_p123-142.indd 125                                                               4/26/2010 4:23:53 PM
         126          Terrence W. Deacon

                      induced change. The conceptions of energy as ineffable ether or as
                      ...
                      ject to exact analysis and the basis for myriad new technologies.
                             Similarly, I argue that in order to develop a full scientiﬁc under-
                      ...
                      tion from other merely physical relationships, we will need to ﬁnd a
                      precise way to characterize its deﬁning non-intrinsic feature – its ref-
                      erential content – and show how it can be causally efﬁcacious despite
                      ...
                      istence” when describing mental phenomena.
                               ...
                               can, therefore, deﬁne mental phenomena by saying that they are those
                               phenomena which contain an object intentionally within themselves
                               (Brentano, 1874).

                             As I will argue below, both the engineer’s identiﬁcation of infor-
                      ...
                      granted. The ﬁrst takes it for granted but then proceeds to bracket it
                      ...
                      tive, and brackets its necessary physicality and efﬁcacy from consider-
                      ...
                      It is, however, employed somewhat differently in each ﬁeld, to the
                      extent that the aspects of the concept that are most relevant to each

9780521762250c08_p123-142.indd 126                                                                       4/26/2010 4:23:53 PM
                                                 What is missing from theories of information?        127

                   may be almost entirely non-overlapping. More seriously, the most
                   precise and technical deﬁnition used in communication engineering,
                   ...
                   or contents of our thoughts. The problem that lingers behind deﬁn-
                   itions of information boils down to a simple question: How can the
                   content (aka meaning, reference, signiﬁcant aboutness) of a sign or
                   thought have any causal efﬁcacy in the world if it is by deﬁnition not
                   ...
                   this superﬁcially reasonable account fails to identify any features of
...
9780521762250c08_p123-142.indd 127                                                                4/26/2010 4:23:53 PM
         128          Terrence W. Deacon

                      problem inside as outside the mental world. The problem of specifying
                      how a speciﬁc content is both not physically present and yet inheres
                      ...
                      in neurological processes than it is outside of brains.
                               ...
                               8 .2 M E A N I N G S O F I N F O R M A T I O N
                      ...
                      computer ﬁle encoding this chapter. This is sometimes called syn-
                      ...
                      to experts in the ﬁeld. This is sometimes called pragmatic informa-
                      tion. Currently, the ﬁrst of these meanings has grown in prominence,
                      ...
                      ence ﬁction, would we still call it information if by wild coincidence
...
9780521762250c08_p123-142.indd 128                                                            4/26/2010 4:23:53 PM
                                                          What is missing from theories of information?               129

                   and forth identical to those I have recently sent?1 This would certainly
                   ...
                   tion? Presumably, for any ﬁnite length of randomly generated signals
                   a suitable code could be deﬁned that would change it into English
                   ...
                   assigned a meaning sufﬁcient to make it information? If so, then any
                   signal, from any source, however produced and sent, would qualify as
                   syntactic information.
                          In current computer technology, the rapidly ﬂipping voltages
                   ...
                   and from the magnetically modiﬁed pattern of iron particles embed-
                   ...
                   (1948). As we will see, Shannon’s deﬁnition is more precise than this,
                   ...
                   product of some mindless natural process. It speciﬁes what features of

                           1
                               The absurdity of this happening should also tell us something about the complex-
                               ity hiding behind the notion of information being used here.

9780521762250c08_p123-142.indd 129                                                                                4/26/2010 4:23:53 PM
         130          Terrence W. Deacon

                      a physical material or process are necessary for it to serve as a medium
                      ...
                      to make sense of the enterprise of the natural sciences. Scientiﬁc
                      ...
                      help us to discern how it is that they can be about something else.
                               ...
                               8 .3 L O C A T I N G T H E I N F O R M A T I O N I N I N F O R M A T I O N P R O C E S S I N G
                      ...
                      tial value to some feature of a physical process and to map a speciﬁc
                      ...
                      of signals as an English sentence, so it is possible to ﬁnd a mapping
                      ...
                      when we desire ﬂexibility in possible mappings. This mapping rela-
                      tionship – assigning reference – is crucial for distinguishing between

9780521762250c08_p123-142.indd 130                                                                                              4/26/2010 4:23:53 PM
                                                What is missing from theories of information?       131

                   computing and other merely physical processes. All physical processes
                   ...
                   deﬁned boundary separating the “computing device” and the physical
                   environment.
                   ...
                   are still just as blindly mechanical as in any Laplacian universe.
                          To escape this deﬂationary view of an information universe
...
9780521762250c08_p123-142.indd 131                                                              4/26/2010 4:23:53 PM
         132          Terrence W. Deacon

                      single state exists, only a ﬁeld of potentiality. This is exempliﬁed by
                      ...
                      information. In simpliﬁed terms, this involves an apparent instant-
                      ...
                      that it exempliﬁes a sort of intrinsic representation relationship.
                      ...
                      tions that make them about other features of the world.
                               ...
                               8 .4 I S I N F O R M A T I O N P H Y S I C A L ?
...
9780521762250c08_p123-142.indd 132                                                           4/26/2010 4:23:53 PM
                                                What is missing from theories of information?       133

                   patterns that we recognize as conveying (though not fully constitut-
                   ing) information.
                   ...
                   tiﬁc issues concerning the assessment of information processes in
                   natural systems. A ﬁrst solution to these practical challenges was for-
                   ...
                   information technology, but it also left us with a deﬂationary theory
                   of information, from which content, reference, and signiﬁcance are
                   ...
                   ence to problems of deﬁning content or signiﬁcance, it has led to the
                   rather different uses of the term that we have been struggling to deﬁne
                   and which are often a source of theoretical sleight of hand. By bracket-
                   ing issues of reference and signiﬁcance Shannon was able to provide
                   ...
                   tion to provide information, such as might be discovered by scientiﬁc
                   ...
                   interpreters or for different scientiﬁc instruments the same physical
                   ...
                   and thus are not able to be mapped to any intrinsic properties.
                           Information is by deﬁnition something in relation to something
                   else, but in colloquial use the term can either refer to what is conveyed

9780521762250c08_p123-142.indd 133                                                              4/26/2010 4:23:53 PM
         134          Terrence W. Deacon

                      or what provides the conveyance. If, as in Shannon’s sense, it refers
                      only to the latter, then its aboutness and its signiﬁcance are assumed
                      ...
                      the sign as though it is intrinsically signiﬁcant, irrespective of any-
                      ...
                      dealing with the absent-content problem, speciﬁcally by showing
                      ...
                      Shannon information is deﬁned as the amount of uncertainty that is
                      ...
                      like the decision to deﬁne information capacity with respect to signal
                      ...
                      very features that had to be excluded from this engineering analysis.
                               ...
                               8 .5 T W O E N T R O P I E S

                      By deﬁning information in negative terms with respect to the poten-
...
9780521762250c08_p123-142.indd 134                                                             4/26/2010 4:23:53 PM
                                                 What is missing from theories of information?        135

                   representing medium, whatever form it takes, is necessarily a phys-
                   ...
                   the potential to carry information because it reﬂects the consequences
                   of physical work and thus the openness of this physical signal medium
                   to extrinsic inﬂuence. In thermodynamic terms (Boltzmann, 1866),
                   ...
                   tem in an improbable state reﬂects the effects of prior physical work,
                   ...
                   erence, because this is necessarily a reﬂection of some extrinsic inﬂu-
                   ...
                   sic property but a relational property. It is deﬁned with respect to what
                   is not present. So implicitly, a physical system that exhibits constraint
                   is in that conﬁguration because of extrinsic inﬂuences – but like-
                   wise if the sign medium exhibits no constraint or change from some
                   stable state, it can be inferred that there was no extrinsic inﬂuence
...
9780521762250c08_p123-142.indd 135                                                                4/26/2010 4:23:53 PM
         136          Terrence W. Deacon

                      effect, is the signal feature on which reference depends. This is what
                      ...
                      ered a reduction of referential information because it reﬂects a lapse
                      in the constraint imposed by the language that is necessary to convey
                      the intended message, and yet it is also information about the proﬁ-
                      ...
                      does not exhibit the effects of extrinsic inﬂuence – for example, set-
                      ...
                      can carry signiﬁcance and have dire consequences.
                      ...
                      altered the state of some medium open to extrinsic modiﬁcation.
                      ...
                      reference.
                               ...
                               8 .6 D A R W I N I S M A N D I N T E R P R E T A T I O N
                      ...
                      ciﬁed thus far actually distinguishes events and objects that convey
                      ...
                      terion, only a necessary but not sufﬁcient feature of reference: that
                      is, a semantic conception of information. But of course, not just any

9780521762250c08_p123-142.indd 136                                                           4/26/2010 4:23:53 PM
                                                What is missing from theories of information?       137

                   alteration of entropy constitutes a reference relationship. Although
                   ...
                   they are not sufﬁcient. And yet, as we have seen, reference depends on
                   ...
                   potential is only actualized as it inﬂuences a speciﬁcally structured
                   ...
                   what dynamical organization is sufﬁcient to constitute such a pro-
                   ...
                   that is susceptible to being modiﬁed by physical work, which is used
                   ...
                   tially capable of performing work with respect to such a change.”
                          This is a complicated deﬁnition, but even so it lacks detail con-
                   ...
                   however, we need to ﬂesh out the requirements for a system with
                   the capability to differentially perform work with respect to a given

9780521762250c08_p123-142.indd 137                                                              4/26/2010 4:23:53 PM
         138          Terrence W. Deacon

                      signal state. This is because these requirements will ultimately pro-
                      vide grounding for these additional features, and the basis upon which
                      the possibility for speciﬁc reference can arise.
                      ...
                      medium, it must be open to inﬂuences extrinsic to itself: for example,
                      a larger thermodynamic context to which it is well ﬁtted. Thus the
                      ...
                      system requires a quite speciﬁc matching of dynamical organization
                      ...
                      tivity that deﬁnes representational error is an emergent property of
                      ...
                      ciﬁc environmental conditions that are required for such a dynamical
...
9780521762250c08_p123-142.indd 138                                                             4/26/2010 4:23:53 PM
                                                 What is missing from theories of information?       139

                   persist. Of course, the opposite is also possible; hence the possibility
                   ...
                   the case that this matching of speciﬁc referential relationship with a
                   speciﬁc dynamical modiﬁcation of the capacity to perform work can
                   ...
                   does not exclude the inﬁnitely many ways that information can be
                   ...
                   acity and the evolutionary determination of ﬁttedness. Both involve
                   ...
                   some variants and not others. It is in this sense that we feel justiﬁed

9780521762250c08_p123-142.indd 139                                                               4/26/2010 4:23:53 PM
         140          Terrence W. Deacon
                      ...
                      strate. The variety that is subject to the constraining inﬂuence of nat-
                      ...
                      signiﬁcance of a coincidental event, the meaning of a reading from a
                      scientiﬁc instrument, the portent of the pattern of tea leaves, and so
...
9780521762250c08_p123-142.indd 140                                                             4/26/2010 4:23:53 PM
                                                What is missing from theories of information?       141
                   ...
                   lutionary process, all have a deﬁnite negative extension in the sense
                   that something speciﬁc and explicit is missing. In other words, like the
                   ...
                   ena to a disembodied realm is a reﬂection of this negative deﬁning
                   feature, but the apparent paradoxes this creates with respect to the
                   physical efﬁcacy of informational content is the result of misinterpret-
                   ...
                   consideration of intentionality in deﬁnitions of information, as the
                   ...
                   ence” problem in these ways guarantees that the real-world efﬁcacy of
                   ...
                   interacting with the outside world. It is, in a precisely deﬁnable sense,
                   ...
                   physical difference. And it has its inﬂuence on worldly events by virtue
                   of the quite precise way that it is not present. Attempts to attribute a
                   quasi-substantial quality to information or to reduce it to some speciﬁc

9780521762250c08_p123-142.indd 141                                                              4/26/2010 4:23:53 PM
         142          Terrence W. Deacon

                      physical property are not only doomed to incompleteness, they ultim-
                      ...
                      Bateson, G. (1972). Steps to an Ecology of Mind: Collected Essays in Anthropology,
                          Psychiatry, Evolution, and Epistemology. Chicago, IL: University of Chicago
                          Press.
                      Bickhard, M. H. (1998). Levels of representationality. Journal of Experimental and
                          Theoretical Artiﬁcial Intelligence, 10(2): 179–215.
                      Bickhard, M. H. (2000). Autonomy, function, and representation. Communication
                          and Cognition – Artiﬁcial Intelligence, 17(3–4): 111–131.
                      Bickhard, M. H. (2003). The biological emergence of representation. In Emergence
                          and Reduction: Proceedings of the 29th Annual Symposium of the Jean Piaget Society,
                          eds T. Brown and L. Smith. Hillsdale, NJ: Erlbaum, 105–131.
                      Boltzmann, L. (1866). The Second Law of Thermodynamics. Reprinted in Ludwig
                          Boltzmann: Theoretical Physics and Philosophical Problems, Selected Writings, ed.
                          B. McGuinness, trans. P. Foulkes (1974). Dordrecht: Reidel Publishing Co.,
                          13–32.
                      Brentano, F. (1874). Psychology From an Empirical Standpoint. London: Routledge &
                          Kegan Paul, 88–89.
                      Deacon, T. (2007). Shannon-Boltzmann-Darwin: Redeﬁning information. Part 1.
                          Cognitive Semiotics, 1: 123–148.
                      Deacon, T. (2008). Shannon-Boltzmann-Darwin: Redeﬁning information. Part 2.
                          Cognitive Semiotics, 2: 167–194.
...
9780521762250c08_p123-142.indd 142                                                                          4/26/2010 4:23:53 PM
