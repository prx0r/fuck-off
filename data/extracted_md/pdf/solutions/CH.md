# Submitted to                                             LBL-Z07Z

**source:** pdf · **section:** solutions
**file:** CH
---

Physical Review                                          Preprint ~.I

        EXPERIMENTAL CONSEQUENCES OF OBJECTIVE
                   LOCAL THEORIES I

                  John F. Clauser and Michael A. Horne

                               August 1973

        Prepared for the U. S. Atomic Energy Commission
                 unde r Contract W -7405 -ENG-48
...
                                               ,
     ...
     EXPERIMENTAL CONSEQUENCES OF OBJECfIVE LOCAL THEORIES 1*
                            JOM F. Clauser
\,
        Department of Physics and Lawrence Berkeley Laboratory
                    University of California
                    Berkeley, California 84120
                                  and
                            Michael A. Horne
...
considered such theories in conjunction with a "locality" or
                                 1
'inacrocausality" requirement.       This requirement (reasonable for
...
properties which it is known will be the results of certain
...
                                           -,
 ...
 suitable experiments JJi.ay beperfonned whiCh will either' disprove
...
be oriented along directions ,..,.,..,.
                              a and b by the experimenter
                                                    .
                                                          or
experimenters.
                 .
...
those with spin opposed to a(b) are ignored.
                                                  8
                                                      --
                      Particles with their spin along a(b) are detected;
...
orientations ,.,..
              a andb,
                   I¥'"
                        but the rate of molecUlar dissociations will
...
                                -7-
 ...
 We equip each apparatus with a c16ckproducing tirile intervals

 of total length-     +~The two clocks have been synchronized
 beforehand.       Each time interVal (t , t +1 ) we divide into three
                                        i i
...
- Either detector output in each interval of time is thus constrained
 to be in one of the two final states 8 : +1 or O. - This procedure will
...
                                -8-
 ...
 autanmtic equipment) the various experimental outcomes.           Second,     -,,
 ...
 the apparatus was set at the orientation pair a, b.
                                                     --     For this (and
...
. combinations.   Thus N++ (~,.2) is the total number of time intervals
 ...
 the results A = +1 and B= +1 occurred; etc.
                                                            ..
...
space-time localized signals, so that such signals may be
...
In other words,. sources with "free will" must exist, for locality
      .          .     10
to h ave any meanIng.         Such signals presumably can then exist which
...
                                      ..;11-
       ...
       associated signal source for apparatus parameters with an imaginary
...
'.'    box greater than CT     (see Fig. 3).     Our postulates imply that a
       ...
       within the surface ~ A at time t i .
            We denote by the symbols AA and AB the set of natural properties
       contained within the surfaces ~ A and ~ B' respectively, at time t i •
       Thus, AA fully specifies the "objective state" or " ultlmate
                                                               •
                                                                    essence N
...
apparatuses, any correlation between the paired results             must
...
assuming the random processes to be ergodic l l ) there will be a
...
at an earlier time t.,
                    1  to be dependent upon quantities _a and b which     ~

are not yet defined.    Conversely, our objectivity postulate allows

                  -
the generation of a and b to be independent of AA and AB.
                         '""-                      .
...
of AA and AB among the members of the ensemble, being justified in
                                          ...
                                          -
introducing it as independent of a and b. We leave open the specific
                                              I   "..
...
                                -13-
       ...
       Randomness has entered through the unknown initial conditions,
...
Correspondingly there is a probability I13C2,A ) defined at the surface
                                              B
...
chosen subensemble of associated A outcomes, and vice versa.          If
 ...
 this fraction is not then uniquely specified by ~ and A . Therefore
                  . I                                   B
the probabilities PA and I13 must be independent.         This independence

implies that for fixed ~, 2, AA' and A , we can write the probability
                                      B
...
both apparatuses record the +1 result by averaging w over the· entire
sample space of AA and AB• This probab i1 i ty is then

      W[                                 f
           A(~)+. B!l!) +J " W(ij .Il) = PA(~.AA)% Cl/.. AB) P(AA' AJildAAdAB    (6)

In similar fashion the probability that the apparatus A will record
+1, irrelevantly of B's result is

         II
     wA (ll) =        PA (i!oA A) PD'A'AB)   ~ A~B'                              (7)

Likewise for apparatus B we have

     wB~ JI           11lC!l. AB)Po,A·AB) ~A~B'                                  (8)

     Let us now be more specific about the experimenter's choice                                   iI
                                                                                                   !
                                                                                               .   ;

for the apparatus parameters.1 Consider the case in which only two                                 I
...
us to. define the four probabilities PA (~,AA)' PA (i,.', AA)' PB (£.,A B) ,
and PB~' ,A B) associated with the objective properties inside the
surfaces LA and LB.
     The remainder of the demonstration is purely mathematical.                 We
use a theorem, proved in the appendix which states: Given any
six numbers Xl' x z' Yl' YZ' X, and Y such that the inequalities
...
                                       -16-
 ...
 all objective,· local, theories of nature.                       In many relevimt experiments
 such· as Balun's --'CGe..;,.daIik._·                ....
                                                    ··..;..r_im_·ent,
                                _. ....;·e.;..·rt_e_xpe
                                                 -
                                                   .....
                                                               -      a and b may be taken as scalar
...
to the analyzer orientation.                     We rewri te th~se in ·the following
                                                       E;im • !he quanttun mechanical

prediction for the coincidence rate is then 12
...
            "
       ...
       initial state.       For an initially pure singlet (S=O) state we have
.'
,
       ...
       axis in their plane. , Here, Rp is the rate at which correlated particles
       simultaneously enter both collimators (proportional to the d1ssociation
      rate).        Ra
                     is the
                          ,
                            tmavoidab1e accidental rate .which in a well
      ...
      Here      r/ and nB are the "gathering efficiencies for the collimators
                                              i,
...
analysis of the measurement process, Jauch has recently introduced
                                                       .                    15
a new concept 0 f state which is in many respects eqUIvalent to ours.
...
                                          -21-
             ...
             microscopic and macroscopic phenomena.     Any such models, if they
...
.~
            ...
            assumptions.      The wave function Wmay not be simply substituted for
            ourvariablesA A and ABO       In this case our postulate requires that
 ...
 ,.:.   .
            a correlation is to recognize that the state Wis not pure, but a
...
                            -22-
     ...
     Together then, objectivity and macrocausality are
...
then the function U = X1Yl -XI Y2 +X2Y1 + X2Y2 - YX2 - XY1 is
...
U,   thus:
      ...
      U = Xl (Yl - Y2) + (X 2   -   X)Yl + X2(Y2 - Y)
      <
       - XI(YI - Y2) + (X 2 - X)YI + X1 (Y2 - Y) =                (AI. 3)

       (X2 - X)Yl + Xl (Yl - Y).
                                                -24-

Inspection and application of IneqS. (Al.I) show                                              that both of the
...
is established for all cases.
        ...
        The proof of the lower botmd follows from a consid.eration of
                                                  .       > .
three cases.                  First, assume x             - x1 .        The validity of the lower
                                                      2

bound is apparent by inspection when written in the form

        U + TI = (X - x )(Y - Y ) + x y                                 + (x        - x )y            (Al.4)
                                            2    1              11             2          1·2)
...
observer's particular technological ability to measUre them.     Strong
objectivity is to be contrasted with weak objectivity.    This latter
viewpoint merely stipulates that the results of observations are
independent of who observes them.     The usual interpretations of
quantum mechanics are consistent with weak but not strong objectivity.
The distinction between these views is discussed by B. d'Espagnat in
Ref. 14.
                            -26-

                             -
       Hartle [Am. J. Phys. 36, 704 (1968) 1 gives . a noteworthy
                                             ..   ""

alternative definition of objectivity which is, however, tmsatisfactory
for our purposes.     We quote, " ... the state will be called an objective
property if an assertion of what the state is can be verified by
measurements on the individual system without knowledge of the
system's history." The ultimate limitation to possible measurements
is, tmforttmately, unknown, and present limitations may perhaps be
only technological ones.     Quantum mechanics assumes the tmcertainty
principle to place a ftmdamental limitation on measurements.        Since
it would be circular for us to assume- "!priori the c.oi'Tectnessof a
theory whose veracity we currently question, we cannot in the present
instance accept this limitation.     Hartle's statement is meaningful
only if one knows the ultimate limitation to physical measurements.
It can equally well be used to define this liniitation.

S   Indeed, Bell (Ref.l) considered a quite general case which included
"indetenninism with a certain local character." Unforttmately, this
phrase alone was the full extent of his description.      Understandably
it led to subsequent confusion; see K. Popper, in Perspectives in
QUarttumTheory:     Essays iIi Honor of Alfred Lande, edited by W. Yourgrau
and A. Van der Merwe (MIT Press, Cambridge, 1971), p.182.      Some of

(1972)].   Nonetheless, even though Bell's conclusions were indeed
                                                                    --
the confusion was subsequently clarified [J. S. Bell, Science 177, 880
                               -27-

 correct, the difficulties discussed i..'1 Ref. 8, prevented his analysis
 from so proving them.Nei thera fully general argument, nor a
 prescription for a conclusive test has heretofore been exhibited.
 6   D. Borun,Q.!antum Theory' (Prentice Hall Inc., Englewood Cliffs ,N.J.

 1951), p.614.
 7
     J. F. Clauser and M. A. Horne, Part II of this two-part article.
 Phys.' Rev.
 8
     J. A. Crawford (see Ref. 1) and P. M. Pearle [Phys. Rev. D .,..
                                                                 2,
 1418 (1970)] h~ve noticed that the systems considered by Bell are
 not two-state systems, but in fact three-state systems.        The third
 state corresponds to the situation in which one or both particles of
 a pair are not observed.    Bell, to counter this argument suggested
 that a given apparatus could respond +1 for "spin up," -1 for "spin
 down," and 0 ,for "unobserved.   tI
                                       Unfortunately, his prescription is
 either incomplete or ineffective.        In the same paper he derives an
 inequality constraining correlation functions, which to be measurable,
 nrust be normalized to the total m.vnber of events.      If! the unobserved
 flux of particles is assumed to be arbitrarily large, the predictions
 by quantum mechanics and Bell's assignment yield no violation of his
 inequality, since his correlation ftmctions vanish in'this limit.
 The unobservability of some events prevents their enumeration in his
,case.   Pearle derived a lower limit to the unobserved flux of-particles
 necessary to prevent an experiment from conclusively testing for the
 existence of hidden variables.        He did not, however, consider the
 possibility of using only observable data to draw conclusions despite
                            -28- .

 the existence of the UnobserVed particles, as we do here.    The
 present discussion avoids the above difficulty by reverting to a
 consideration of two-state systems.    Spin-down particles are
 grouped with unobserved ones, and both assigned the value zero.
 This assignment does indeed still yield a violation of the
 inequality we derive, even for a large flux of unobserved particles.
 9   The idea of readjusting the analyzers while the particles are in
 flight is Originally due (essentially) to D. Bohm and Y. Aharonov, .
 Phys. Rev.Jj~" 1070 (1957).
10   It has already been noticed that strict determinism may be
 incompatible with free will [H. P. Stapp, Phys. Rev. D ~ 1303 (1971)].
Hence, a logically defensible alternative is that spontaneous
 signal sources cannot exist.    In this case a signal may be received
outside of the transmitter's light cone, but the causality violation is
only apparent.    Both the transmitter and receiver were predetermined
to exhibit the same signal.     The point of origin of the "actual" signal
was some point wi thin the light cones of both.   Here, then, the
locality postulate is meaningless.     This position seems rather
farfetched, however, since for a Lorentz-invariant objective theory
to produce the required correlation in our proposed experiment, it
is necessary that the properties of the measured objects actually
corrommicate with the experimenter.    Indeed, they must convince the
experimenter without his knowledge to set the apparatus in a marmer
specified by the objects themselves.    We will thus ignore this possibility.
                              -29-

11   To perfonn an ensemble of identical experiments on an associated

 ensemble of quanttnn systems will indeed. be expensive!     Nor will it

 even be practical to assure that such ensembles are in fact identical.

 More practically, one may use an ensemble of identically prepared

 quanttnn systems, and the same apparatus repeatedly.      To do so one

 must, however, assume that the associated random processes are
 ergodic .. The invariances of nature required by the ergodic hypothesis
 [see for example D. Middleton, Introduction to Statistical Crnmnunication

 Theory OMcGraw Hi11,New York, 1960), p.S6] are so natural that they
 are tacitly assl~d by practically every experimenter.        Strictly
 speaking, however, ergodicity does represent an additional assumption,
 if the experiment is to be perfonned in this manner.

12   These results apply only in the low rate limit such that the counter

 "dead time" is small, i.e .. when T«1/r ..

13   In any real experiment the effective path lengths and flight times

 for the paired atoms will vary so that R and lli will both depend
                                         a
 upon T.
14   B. d'Espagnat, Conceptual Foundations of Quanttnn Mechanics (Benjamin,
Menlo Park, Calif., 1971), Chapters 8, 9, and 16.
15   J. M. Jauch, in Foundations of ·~antumMechanics, p~20(s~eRef~Yi:1) •
                               -30-

16   For example, M. L. Goldberger and K. M. Watson [Phys. Rev. 134,  ~

 B 919 (1964)] consider a system composed of two spin-l/2particles.
 Th~connnent:    " ... IIi general therefore the observation of the
 orientation of spin 1 with respect to the axis has an instantaneous
 effect on the state of the second spin.      With the interpretation of
 an observation as making a selection among the members of an ensemble,
 this is in no sense surprising."         The above discussion shows that
 such an interpretation cannot of course be considered correct.
17   W. H. Furry, Phys. Rev. 49, 393 and 476 (1936).
18
                              """'"
     B. d'Espagnat, in Preludes in Theoretical Physics; in Honor of
 v. F. Weisskopf, edited by DeShalit et a!. (North Holland Pub!. Co.,
 Amsterdam, 1966), p.185
19   This principle states that the commutator of any two operators must
vanish if they correspond to measurements made outside of each other's
 light cones.
                                                                      -
                 Following R. Haag and B. Schroer [J. Math. Phys. 3, 248
 (1962)] this principle is often referred to as the Einstein causality
 condition.     In view of the above discussion and Einstein's conviction
 concerning physical reality, the term is clearly a misnomer.
      ! '
...
Figure 4.       Analyzer orientations for maximum violation with
     F = + 1 (</f = 45 0 ) .   Maximum violation for F = - 1 occurs

                                                   ...
     with cp= 135 0 (reverse directions of b and .....,
                                                  b').
-32-
...
•
      ...
      record                                                          I                       I
                                               ...
                                               tj
      Clock pulses                                          / 1+1
                 III III III III III hi III III I"                        I" I" hi III I" h, 1., l!l I
