...
William Heinemann, Ltd., 1961;'New York: Basic Books, Inc., 1962).
    1
      F. J. Dyson, Scientific American, 199, 74 (1958). Several cases are related in
...
in 1911.
                                        ...
                                        171
172                        Symmetries and Reflections

view2 though fewer among the physicists than — ironically enough —
among biochemists.
...
vacuum would be. All that is relevant is that the concept of the electric
    2
       The book most commonly blamed for this view is E. F. Haeckel's Weltratsel
( 1 8 9 9 ) . However, the views propounded in this book are less extreme (though
more confused) than those of the usual materialistic philosophy.
     3
       W. Heisenberg expressed this most poignantly [Daedalus, 87, 99 (1958) ]: "The
...
refer to the observer.
    4
       J. von Neumann, Mathematische Grundlagen der Quantenmechanik            (Berlin:
Julius Springer, 1932), Chapter VI; English translation (Princeton, N.J.: Princeton
University Press, 1955).
                     Remarks on the Mind-Body Question                             173

field is useful for communicating our ideas and for our own thinking.
...
and its wave function will tell us with what probability we shall see a
    5
      The contents of this section should be part of the standard material in courses
...
1939). The last authors observe (page 4 1 ) , "Remarquons le role essential que joue
la conscience de 1'observateur. . . ."
174                     Symmetries and Reflections
...
                   Remarks on the Mind-Body Question                       175

: . to + 1, r0 + 2, • • • , and our possible sensations are seeing or not seeing
...
see a flash at time t, you will see a flash at time t + 1 with a probability
 l
   /4, no flash with a probability %; if you see no flash, then the next
...
other words, he can tell us what the wave function is: i/o if he did, i/^ if
...
176                        Symmetries and Reflections
...
the last two sections: that it is incompatible with quantum theory. The
    6
      The essential point is not that the states of objects cannot be described by means
...
                    Remarks on the Mind-Body Question                          177
...
all this, one may well wonder how materialism, the doctrine 8 that "life
...
ing ourselves if we want to survive.
    7
      N. Bohr, Atomic Physics and Human Knowledge, section on "Atoms and Hu-
man Knowledge," in particular p. 92 ( New York: John Wiley & Sons, 1960).
    8
      The quotation is from William S. Beck, The Riddle, of Life, Essay in Adven-
tures of the Mind (New York: Alfred A. Knopf, I 9 6 0 ) , p. 35. This article is an
eloquent statement of the attitude of the open-minded biologists toward the ques-
tions discussed in the present note.
178                        Symmetries and Reflections
...
traditional answer to this question is, "No": the body influences the
 ...
 as the second thesis.
    ...
    9
      This writer does not profess to a knowledge of all, or even of the majority of all,
...
nica.
                     Remarks on the Mind-Body Question                         179
...
of object plus observer will be, after the interaction, ij/1 X X i; if the state
...
accept this, we are driven to the conclusion that the proper wave func-
   ...
   10
      F. London and E. Bauer (op. cit., reference 5) on page 42 say, "II [l'observa-
...
son propre etat."
180                         Symmetries and Reflections

tion immediately after the interaction of friend and object was already
either yq X X l or yq X x2 a n ( i not the linear combination a (yq X Xl ) + B
...
which neither yh X A i nor y2 X X2 has. If we substitute for "friend" some
...
the existence of the consciousness of a friend to this extent is surely an
   11
      In an article which will appear soon [Werner Heisenberg und die Physik
...
theory cannot have unlimited validity (see, in particular, Section Ilia, also V e ) .
...
                  Remarks on the Mind-Body Question                    181

^r.natural attitude, approaching solipsism, and few people, in their
...
182                     Symmetries and Reflections

in which way the consciousnesses are related to each other and to the
...
covered. Hence, lack of success in the past need not discourage.
   12
      This statement is certainly true in an approximation which is much better
than is necessary for our purposes.
                      Remarks on the Mind-Body Question                              183
...
was pointed out already by Bohm 14 that, if the system is sufficiently
...
the picture. 15 We saw that the linearity condition led uniquely to the
   13
      The concept of the mixture was put forward first by L. Landau, Z. Physik, 45,
...
35-38.
   14
      The circumstance that the mixture of the states (i/q X Xi) a n d (vAr X X2)'
...
of this treatise.
   15
      The non-linearity is of a different nature from that postulated by W. Heisen-
berg in his theory of elementary particles [cf., e.g., H. P. Diirr, W. Heisenberg,
H. Mitter, S. Schlieder, K. Yamazaki, Z. Naturforsch., 14, 441 ( 1 9 5 4 ) ] . In our case
the equations giving the time variation of the state vector (wave function) are
postulated to be non-linear.
184                      Symmetries and Reflections

unacceptable wave function a ( ^ X X] ) + B (^2 x x2) r o r t n e j 0 m t stafe-
...
probabilities jal 2 and 1/3 J2, so that every member of the continuous
...
•Ai x Xi> the second to y2 X        The 8 = 0 case corresponds to orthodox
                                x2
...
of \j/x X A l and \p2 X x2, with probabilities j a | 2 and |/3j 2 , respectively.
...
a(<Ai X Xi) + P(fl>* x X2) and -B*(#i X Xi) + a°(>A2 X x 2 ) for 8 = 0 and
