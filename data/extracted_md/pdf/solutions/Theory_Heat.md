...
that of the surrounding air, the cloud will ascend.
 ...
 least of which can afterwards be exhibited in the form oi
visible work.
...
j relatively to each other. If, therefore, the body is hot
...
J    sence of a cold body is essential to the radiation of heat by
     ...
     heat; and the reason why each body remains of the same
...
/     cannot be taken as a demonstration that its parts may
    ...
    i ever hot it is. The motion which we call heat must there-
...
phenomena of gases.
   It is to Professor Clausius, however, that we owe the recerj
development of me dynamical theory of gases.
     3°6                Molecular    Theory.
 ...
 ^i All bodies consist of a finite number of small parts called
...
              Encounters between Molecules.              3°7
...
calculations.
            ...
            ON T H E KINETIC THEORY OF GASES.
...
the distribution of observations according to the magnitude of        f
their errors, as described in the theory of errors of observation. V\
...
or a diffusion of velocity or of heat, mathematical expressions    ^A
of this exponential form are sure to make their appearance.        ^T
...
mediate velocities. To compare one such system with
...
the Velocity of Mean Square.                    /icref ^^ts S<AACU^C
                                                             f
...
during successive free paths not being subj ect to any law
...
j     molecule in its course, such a being, whose attributes are still
vJ    as essentially finite as our own, would be able to do what is
  v   at present impossible to us. For we have seen that the
J     molecules in a vessel full of air at uniform temperature are
^      moving with velocities by no means uniform, though the
 \     mean velocity of any great number of them, arbitrarily
      ...
      who can see the individual molecules, opens and closes this
       ...
       from A to B, and only the slower ones to pass from E to A.
       H e will thus, without expenditure of work, raise the tern-
               Statistical Knowledge of Bodies.            329
   ...
   to abandon the strict dynamical method, in which we follow      1*
...
j?        all exactly alike, but different from those of other substances.
          There is not a regular gradation in the mass of molecules
          from that of hydrogen, which is the least of those known to
...
T
 \f
      1   mediate links are found to connect one species with
          ...
          species, and that intermediate links between the species are
...
_v            In the case of the molecules, however, each individual is
...
        Equality and Permanence of Molectdes.               331
...
       332                     Molecular    Theory.
       ...
       molecule.
 or^       But if we suppose the molecules to be made at all, or if
y-
       ...
       Table of the Coefficients of Interdiffusion of Gases, from the Memoir oj
          Professor Loschmidt {see p. 279), in square centimetres per second

             Carbonic acid           . Air.                       •1423
                 —                     Hydrogen                   •S6i4
                 —-                    Oxygen .                   •1409
                 —                     Marsh gas                  •1586
                 —                     Carbonic oxide .           •1406
