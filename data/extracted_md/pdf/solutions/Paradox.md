...
g<^s are mixed. If we denote by vlf v2, etc., the initial volumes of the
...
increase of entropy may be written in the form
                           E1(m1a1) log V —S 1(m1a1log vx).
And if we denote by rlt r2, etc., the numbers of the molecules of the
several different kinds of gas, we shall have
                     rx= (7m1a1, r2= Cm2a 2, etc.,
where G denotes a constant.             Hence
                           v1:V :: m1a1:2 1(m1a1) :: r x: H1r l ;
and the increase of entropy may be written
                                  log Z £ i - S / n log r,)                          ^298)
...
components the gases Gx, G2, and Gs, the units of which are denoted
by ©!, © 2 , ®3, and that in ultimate analysis
                                  ©3 = X1©1+ X2©2,                                   (299)
\  and X2 denoting positive constants, such that X1+ X2= l. The
...
constant quantities of G1 and G2, as determined in ultimate analysis.
For such phases, by (86),
                      /q Sm 1-f y 2 Sm 2 -f juls Sm3 ^ 0       (300)
for such values of the variations as do not affect the quantities of
Gx and G2 as determined in ultimate analysis. Values of $m v Sm 2,
SmB proportional to     X2, —1, and only such, are evidently consistent
with this restriction: therefore
                                      Xi/li + X2yU2= yU3.                            (301)
  If we substitute in this equation values of /q, p 2, /q taken from
(276), we obtain, after arranging the terms and dividing by t ,

           \   «1 lo S “    + ^2 «2 lo g “   -   «S   log n^ = A + B l o S t - J <   (3 0 2 )

where
        d —Xj       "t X2Id2 E 3 \ q X2c2~(-q —*X| cq —■X2u,2 | oq,                  (303)
                              JB= XjCj -j- X2c2 Cg,                                  (304)
                              C= \ E x+ X2E 2—E z.                                   (305)
