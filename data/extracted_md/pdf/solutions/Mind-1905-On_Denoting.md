...
**file:** Mind-1905-On_Denoting
---

                 BY BEBTBAND BUSSELL.

                                                                  Downloaded from http://mind.oxfordjournals.org/ at Harvard Library on February 5, 2016
...
about them is obtained through denoting. Ail thinking has
...
grounds in favour of my theory; and finally I shah1 briefly
...
tion J in which x is a constituent, where x, the variable, is
essentially and wholly undetermined. Then we can consider
the two notions " C (x) is always true " a n d " C (x) is some-
times true ".' Then everything and nothing and something
...
position in whose verbal expression they occur has a mean-
ing. The difficulties concerning denoting are, I believe, all
the result of a wrong analysis of propositions whose verbal
expressions contain denoting phrases. The proper analysis,
if I am not mistaken, may be further set forth as follows.
   1
     1 have discussed this subject in Principles of Mathematics, chapter
T., and § 476. The theory there advocated is very nearly the same as
...
it to mean, " It is not true that ' C (x) is fake' is always true ".
   4
     1 shall sometimes use, instead of this complicated phrase, the phrase
" C (i) is not always false," or " C (x) is sometimes true, supposed defined
to mean the same as the complicated phrase.
                         ON DENOTING.                           481

    Suppose now we wish to interpret the proposition, " I met
a man ". If this is true, I met some definite man; bat that
is not what I affirm. Wha 11 affirm is, according to the theory
I advocate:—
...
" C (a man) " means " ' C (a;) and x is human ' is not always
       false ".
...
This proposition1 is really hypothetical and states that if any-
...
This is what is expressed in symbolic logic by saying that
 ...
 " C (all men) " means " ' If x is human, then C (x) is true' is
       always true ".
 Similarly .
 " C (no men) " means " ' If x is human, then C (a;) is false '
       is always true ".
 ...
 Charles IL and was executed. Now the, when it is strictly
 ...
 would be more correct to say " a son of So-and-so ". Thus
  ...
  when we say "x was the father of Charles i t " we not only
 assert that x had a certain relation to Charles II., but also
  1
   As has been ably armed in Mr. Bradley^ Logic, book i., chap. ii.
  * Psychologically " C (a man) " has a suggestion of oidy one, and " C
(some men) h has a suggestion of more than one; but we may neglect
these suggestions in a preliminary sketch.
482                   BEBTRAND RUSSELL:

that nothing else had this relation. The relation in ques-
tion, without the assumption of uniqueness, and without any
denoting phrases, is expressed by " x begat Charles EL". To
get an equivalent of " x was the father of Charles II.," we
must add, " If y is other than x, y did not beget Charles II.,"
or, what is equivalent, " If y begat Charles IX, y is identical
with x". Hence " x is the father of >Charles II." becomes
" x begat Charles I I . ; and ' if y begat Charles II., y is identical
with x' is always trae oly".
...
theory.
   To interpret " C (the father of Charles IL)," where C
...
" It is not always false of x that ' if y begat Charles IX, y is
      identical with x' is always true of y,"
...
denoting phrases occur to form3 in which no such phrases
...
" the present King of France," " the round square," etc., are
  1
    See Untf.rBuchunf/m rur Or.yr.nstandstheorie und Psycholm/iK, Leip-
...
Frege's theory. He distinguishes, in a denoting phrase, two 1

                                                                              Downloaded from http://mind.oxfordjournals.org/ at Harvard Library on February 5, 2016
elements, which we may call the meaning and the denotation.
...
the view that 3denoting phrases express a meaning and denote
a denotation, concerns the cases in which the denotation
...
France ". But this phrase, though it has a meaning provided
  1
      See his " Ueber Sinn und Bedeutung," Zeittc.hrift fur Phil, und Phti.
Krilik, vol. 100.
...
meaning! of the constituents of a denoting complex that enter into its
...
not the actnal mountain, that is a constituent of the meaning of the pro-
position.
...
they denote a denotation. In the other theory, which 1 advocate, there
is no meaning, and only sometimes a denotation.
484                 BERTRAND RUSSELL :

" the King of England " has a meaning, has certainly no de-
...
the autlior of " Waverley," and thereby prove that George IV.
...
than " I am the subject of a proposition, therefore I am,"1
provided " I a m " is taken to assert subsistence or being,
...
culties must be wrong.
 ...
 31                 ' I DM these a» synonyms.
486                 BEBTBAND BUSSELL :
...
" The firtet line of Gray's Elegy " does not state a proposi-
...
the meaning (if any) of the denotation. " The meaning oi
...
stances '. Then
 ...
 But what we meant to have as the denotation was " the first
line of Gray's Elegy ". Thus we have failed to get what
 we wanted.
   The difficulty in speaking of the meaning of a denoting
 complex may be stated thus: The moment we put che com-
...
to havb both meaning and denotation. The right phrase,
...
whenever C occurs without inverted commas, what iB said
...
be abandoned.
   It remains to show how all the puzzles we have been con-
...
I say " Scott was a man," that is a statement of the form
                                                                  ...
                                                                  Downloaded from http://mind.oxfordjournals.org/ at Harvard Library on February 5, 2016
"x was a man," and it has " Scoit " for its subject. But
...
what was said earner ; but it is easier to follow.) And speak-
ing generally, suppose we wish to say that the author of
 Waverley had the property $, what we wish to say is equiva-
...
the author of Waverley," which was written out in its un-
...
" I t is false that there is an entity which is now King of
      France and is bald ".
...
and B do not differ. If A and B do differ, there is toe and
...
"a~R b" stands for "a has the relation E to b," then when
a B b is true, there is such an entity as the relation R between
a and b; when a R b is false, there is no such entity. Thus
out of any proposition we cas make a denoting phrase, which
...
sun, and fake that the sun revolves round the earth; hence
...
comes:—
   " There ie one and only one entity x which is most perfect;
...
have being.
   * The argument can be made to prove validly that all members of the
olaee of most perfect Beings exist; it can also be proved formally that
this class cannot have more than one member; bat, taking the definition
of perfection ae possession of all positive predicates, it can be proved
almost equally formally that the class does not have even one member.
492                  BEBTBAND BUSSELL :

noting phrases. Most mathematical definitions are of this
sort: for example, "m—n means the number which, added to
n, gives m ". ThusTO—nis defined as meaning the same as
...
pression contains a denoting pnrase. In the case where m
and n are such that there is one and only one number x

                                                                     Downloaded from http://mind.oxfordjournals.org/ at Harvard Library on February 5, 2016
which, added to n, givesTO,there is a number x which can
be substituted forTO—n in any proposition containing m — n
...
of Waverley, or that thou art identical with another term,
 ...
 Thus in every proposition that we can apprehend (».«. not
...
ties. Hence, although we can form prepositional functions
...
sequently, knowing any Bingle proposition of which the thing
...
his own on the subject of denotation. This attempt, 1 be-
