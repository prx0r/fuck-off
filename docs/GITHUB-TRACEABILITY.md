...
| `hound` (clone, scabench-org) | (study — belief/hypothesis graph, observations-vs-assumptions, iteration-verified confidence) | L00/L08 | REFERENCE — stealable: iteration-verified confidence + scout/strategist model split |
