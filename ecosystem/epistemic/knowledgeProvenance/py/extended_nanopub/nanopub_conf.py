...
from extended_nanopub.definitions import NANOPUB_SERVER_LIST
...
class NanopubConf:
    ...
    Args:
        profile: Profile of the user publishing the extended_nanopub
        use_test_server: A boolean to automatically use the test server
        use_server: The URL of the server that will be used to publish the extended_nanopub
