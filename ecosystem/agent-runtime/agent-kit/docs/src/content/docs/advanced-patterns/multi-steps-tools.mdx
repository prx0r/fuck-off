...
<CardGrid>
<LinkCard title="Configuring Multitenancy" href="/advanced-patterns/multitenancy" description="Learn how to configure user-based capacity for your AgentKit network." />
<LinkCard title="Customizing the retries" href="/advanced-patterns/retries" description="Learn how to customize the retries of your multi-steps tools." />
</CardGrid>
