...
<CardGrid>
  <LinkCard title="Hacker News Agent with Render and Inngest" href="https://github.com/inngest/agentkit-render-tutorial" description="A tutorial showing how to create a Hacker News Agent using AgentKit Code-style routing and Agents with tools." />
