...
> Patala v2 spec'd a coherent system. We built 22 kernels + 59 experiments that PROVE the mechanisms
...
- `../scripts/theatre-check-all.py` — 58 experiments audited; 31 PROVEN on real data, 27 mechanism-only, 0 unproven,
  0 unproven.
