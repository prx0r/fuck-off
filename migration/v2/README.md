...
> Patala v2 spec'd a coherent system. We built 16 kernels + 49 experiments that PROVE the mechanisms
...
- `../scripts/theatre-check-all.py` — 49 experiments audited; 22 PROVEN on real data, 26 mechanism-only,
  0 unproven.
