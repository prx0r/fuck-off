...
> Patala v2 spec'd a coherent system. We built 18 kernels + 55 experiments that PROVE the mechanisms
...
- `../scripts/theatre-check-all.py` — 54 experiments audited; 27 PROVEN on real data, 27 mechanism-only, 0 unproven,
  0 unproven.
